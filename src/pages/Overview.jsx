    ...
    >
      <div>
        ...
        <p className="text-xs text-gray-500">
          ...
          {entry.expirationDate && ` • Exp: ${new Date(entry.expirationDate).toLocaleDateString()}`}
          {entry.startAt && ` • Date: ${new Date(entry.startAt).toLocaleDateString()}`}
        </p>
      </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
              {entriesLoading ? (
                ...
                <div className="p-8 text-center text-gray-400 text-sm italic">
                  No contracts or insurance entries.
                </div>
              ) : (
